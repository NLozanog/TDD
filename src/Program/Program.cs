...
namespace DateFormat
{
    ...
    {
        public static String ChangeFormatISO(String year)
        {
            return year.Substring(6) + "-" + year.Substring(3, 2) + "-" + year.Substring(0, 2);
        }
        public static String ChangeFormatEuropeo(String year)
        {
        ...
        public static void Main(string[] args)
        {
            ...
            Console.WriteLine("{0} se convierte a: {1} ", testDate, ChangeFormatISO(testDate));
            Console.WriteLine("{0} se convierte a: {1} ", testDate, ChangeFormatEuropeo(testDate));
        }
    }
}